...
class GitHub extends OAuth2
{
     ...
     * {@inheritdoc}
     */
    protected $apiBaseUrl = 'https://github.coupang.net/api/v3/';

    /**
     * {@inheritdoc}
     */
    protected $authorizeUrl = 'https://github.coupang.net/login/oauth/authorize';

    /**
     * {@inheritdoc}
     */
    protected $accessTokenUrl = 'https://github.coupang.net/login/oauth/access_token';
