...
abstract class OAuth2 extends AbstractAdapter implements AdapterInterface
{
    ...
    */
    protected function getAuthorizeUrl($parameters = [])
    {
        ...
        qa_debug('OAuth2.php, getAuthorizeUrl(), authorizeUrl='.$this->authorizeUrl);
        qa_debug('OAuth2.php, getAuthorizeUrl(), http_build_query='.http_build_query($this->AuthorizeUrlParameters, '', '&'));
    ...
    */
    public function apiRequest($url, $method = 'GET', $parameters = [], $headers = [])
    {
        ...
        qa_debug('DEBUG - OAuth2.php, apiRequest : url  = '.$url);
        qa_debug('DEBUG - OAuth2.php, apiRequest : method  = '.$method);
        qa_debug('DEBUG - OAuth2.php, apiRequest : params = '.implode(', ', $parameters));
        qa_debug('DEBUG - OAuth2.php, apiRequest : headers = '.implode(', ', $headers));
